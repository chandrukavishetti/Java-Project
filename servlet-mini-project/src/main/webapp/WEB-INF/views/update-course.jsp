...
<body>
	...
	<form action="update-course" method="post">
		...
		Course Name: <input type="text" name="name"
			value="<%=course.getName()%>" required> <br>
		<br> Duration (Days): <input type="number" name="duration"
			value="<%=course.getDuration()%>" required> <br>
		<br> Fees: <input type="number" step="0.01" name="fees"
			value="<%=course.getFees()%>" required> <br>
		<br> Trainer Name: <input type="text" name="trainername"
			value="<%=course.getTrainer()%>" required> <br>
		<br>
