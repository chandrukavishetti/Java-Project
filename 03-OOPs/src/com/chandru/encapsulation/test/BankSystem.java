            ...
            switch (choice) {
                ...
                case 1:
                    ...
                    for (int i = 0; i < dInput.length(); i++) {
                        ...
                        if (ch == '.') { dDots++; continue; }
                        if (!Character.isDigit(ch)) { dValid = false; break; }
                    }

                    if (!dValid || dDots > 1 || (dInput.length() > 1 && dInput.startsWith("0") && !dInput.startsWith("0."))) {
                ...
                case 2:
                    ...
                    for (int i = 0; i < wInput.length(); i++) {
                        ...
                        if (ch == '.') { wDots++; continue; }
                        if (!Character.isDigit(ch)) { wValid = false; break; }
                    }

                    if (!wValid || wDots > 1 || (wInput.length() > 1 && wInput.startsWith("0") && !wInput.startsWith("0."))) {
                        System.out.println("Invalid input. Enter a valid numeric amount without leading zeros.");
                        break;
                    }
